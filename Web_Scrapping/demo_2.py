...
r'''
Focus on the MASTERY instead of EFFICIENCY OF COPY PASTING THE CODE 
'''

r'''
Saving the Files While also Putting the Date it Scrape
Starting pack because it just save thing in here 
'''
# def saving_csv():
...
r'''
Streaming Version where if the script suddenly Stop because of Error 
it will still automatically save 
'''
